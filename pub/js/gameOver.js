class GameOver extends Phaser.Scene {
	...
	create() {
		...
		this.titleText = this.add.bitmapText(screenCenterX, 150, 'soupofjustice', 'GAME OVER', 72).setOrigin(0.5);
		this.altText = this.add.bitmapText(screenCenterX, 250, 'soupofjustice', 'Oh, no... they probed you!', 56).setOrigin(0.5);
